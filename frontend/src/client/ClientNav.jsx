    ...
    <div className="fixed z-50 w-full bg-black text-white">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:block">
          ...
          >
           Go to Cart
           <span className={`absolute ${count>0 ? 'block': 'hidden'} w-[20px] h-[30px] bg-green-600 text-center text-xl rounded-[10px] top-[-0.6px] right-[115px] text-white`}>{count}</span>
          </Link>
        </div>
       ...
       {data.map((data)=>(
         ...
         <span className="relative inline-block">
           <img
             ...
             alt="Dan_Abromov"
           />
           <span className="absolute bottom-0 right-0 block h-2.5 w-2.5 rounded-full  ring-white"></span>
         </span>
       </div>
       ))}
